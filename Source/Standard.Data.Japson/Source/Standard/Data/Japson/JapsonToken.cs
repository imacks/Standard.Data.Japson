...
{
    /// <summary>
    /// This enumeration defines the different types of tokens found within a JAPSON configuration string.
    /// </summary>
    ...
    /// <summary>
    /// This class represents a token within a JAPSON configuration string.
    /// </summary>
    public class JapsonToken
    {
        // for serialization
        private JapsonToken()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JapsonToken"/> class.
        /// </summary>
        ...
        public JapsonToken(TokenType type, int sourceIndex, int sourceLength) 
        ...
        /// <param name="sourceIndex">Index position of raw text source</param>
        /// <param name="sourceLength">Length of raw text source</param>
        public JapsonToken(string value, int sourceIndex, int sourceLength) 
            : this(value, TokenType.LiteralValue, sourceIndex, sourceLength)
        {
        }

        public JapsonToken(string value, TokenType type, int sourceIndex, int sourceLength)
        {
            Type = type;
            Value = value;
        ...
        public static JapsonToken Key(string key, int sourceIndex, int sourceLength)
        {
            return new JapsonToken(key, TokenType.Key, sourceIndex, sourceLength);
        }
        ...
        public static JapsonToken Substitution(string path, int sourceIndex, int sourceLength)
        {
            return new JapsonToken(path, TokenType.Substitute, sourceIndex, sourceLength);
        }
        ...
        public static JapsonToken LiteralValue(string value, int sourceIndex, int sourceLength)
        {
            return new JapsonToken(value, TokenType.LiteralValue, sourceIndex, sourceLength);
        }

        public static JapsonToken Include(string path, int sourceIndex, int sourceLength)
        {
            return new JapsonToken(path, TokenType.Include, sourceIndex, sourceLength);
        }
    }
}
